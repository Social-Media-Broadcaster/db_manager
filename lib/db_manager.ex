defmodule DbManager do
  ...
  @callback create(table_name :: atom, item :: %{id: number}) :: {:ok, id :: String.t} | {:error, reason :: term}
  @callback update(table_name :: atom, id :: String.t, item :: %{id: number}) :: {:ok} | {:error, reason :: term}
  @callback delete(table_name :: atom, id :: String.t) :: {:ok} | {:error, reason :: term}
  @callback get(table_name :: atom, id :: String.t) :: {:ok, %{id: number}} | {:error, reason :: term}
